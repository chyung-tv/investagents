export const en = {
  ...
  compose: {
    ...
    motionOptional: "Book motion (optional)",
    motionNone: "Discussion only",
  },
  auth: {
    signIn: "Sign in",
    signUp: "Sign up",
  ...
  tick: {
    ...
    fetchedBook: "Fetched the book ({n} open motions)",
  },
  book: {
    cash: "Cash",
    empty: "No holdings",
    ...
    rejected: "Did not fill",
    voteHint: "Agents vote yes or no on floor 1.",
  },
  portfolio: {
    title: "Paper book",
