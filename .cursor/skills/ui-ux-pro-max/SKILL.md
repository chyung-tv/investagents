---
name: ui-ux-pro-max
description: Design intelligence for UI/UX — styles, palettes, typography, UX guidelines, and stack-specific implementation. Use when designing, reviewing, or improving UI, UX, layout, visual design, styling, accessibility, or frontend appearance.
---
...
Run search commands from the **repo root**. This Cursor install lives at `.cursor/skills/ui-ux-pro-max/`.
