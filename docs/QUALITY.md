...
| Tests | B- | pytest (including visit prompt smoke, inbox/discover/portfolio client, ledger briefing) + Vitest (`web/src/lib`, settlement math, ledger cash deltas, inbox copy, i18n dictionaries, Floor sources). No e2e. No compose smoke in CI. |
