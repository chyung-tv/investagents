...
| Tests | B- | pytest (including visit prompt smoke, inbox/discover/portfolio client) + Vitest (`web/src/lib`, settlement math, inbox copy, i18n dictionaries, Floor sources). No e2e. No compose smoke in CI. |
